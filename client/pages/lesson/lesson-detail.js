            ...
            <div className="d-flex">
              ...
              <div className="col-sm-6 Left">
                ...
                <div className="detail">
                  {/* 單元一覽 */}
                  <div className="outline detail-wrapp border border-secondary mt40">
                  ...
                  {/* 適合對象 */}
                  <div className="suitable border border-secondary mt40">
                  ...
                  {/* 你將學到 */}
                  <div className="achievement border border-secondary mt40">
                  ...
                  {/* 學員回饋 */}
                  <div className="reviews border border-secondary mt40">
